...
def litCricFriend(wordList, text):
    ...
    newList = [ ]
    for i in splitText:
        newList.append(i.strip(string.punctuation))
    ...
    return(new_count/len(newList))

# PROBLEM 7. Call litCricFriend() four times to find:
#   - the frequency of 'a' and 'an' in The Bells
#   - the frequency of 'the' in The Bells
#   - the frequency of 'a' and 'an' in Canto XII
#   - the frequency of 'the' in Canto XII
# Print out the value returned by each function call, identifying
# what it is. For example, it might say

# >>> bellsAAnFrequency 0.07265587064676617.

# (That is a made-up number.) Each function call takes one line.

print('The frequency of \'a\' and \'an\' in The Bells', litCricFriend(['a','an'], theBells))
print('The frequency of \'the\' in The Bells', litCricFriend(['the'],theBells))
print('The frequency of \'a\' and \'an\' in Canto XII', litCricFriend(['a','an'], cantoXII))
print('The frequency of \'the\' in Canto XII', litCricFriend(['the'], cantoXII))
...
'''
Yes Poe and Neruda use 'a' and 'an' differently as the results show the difference in frequencies.
Yes Poe and Neruda use 'the' differently as shown by the result of frequencies between the two.
'''
